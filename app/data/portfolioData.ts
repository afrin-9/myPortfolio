...
Enthusiastic Computer Science student and versatile developer with hands-on experience in Flutter, React Native, Spring Boot, and the MERN Stack. Skilled in cross-platform mobile app development, full-stack web solutions and UI/UX design using Figma. Adept at translating user needs into intuitive designs and robust applications. Strong collaborator with the ability to adapt to diverse project requirements and deliver high-quality solutions that enhance user experience.
`;
...
export const projects = [
...

  {
    title: "Growth Assist",
    description: `
Spring Boot–based job portal backend with role-based access control, chatbot for career guidance, messaging system, interview scheduling, real-time notifications, and role-specific functionalities for Admin, Recruiter, Job Seeker, Pre-University users.
    `,
    technologies: ["React-Vite", "Tailwind CSS", "Spring Boot", "Java", "Postgres"],
...
Fully responsive Shopify store using Digitic theme with Online Store 2.0. Customized product pages, admin panel, secure payment gateways, multilingual & multi-currency support, and optimized store performance.
    ...
    title: "Job Spring",
    description:
      "A full-stack job portal with role-based access, chatbot, messaging, interview scheduling, and job management.",
