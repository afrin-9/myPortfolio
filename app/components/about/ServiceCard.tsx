...
export default function ServiceCard({
  ...
  return (
    <div className="mr-20 w-full rounded-3xl bg-gradient-to-br from-green-500/40 via-transparent to-transparent hover:scale-[1.02] transition duration-300 border-t border-green-500/40">
